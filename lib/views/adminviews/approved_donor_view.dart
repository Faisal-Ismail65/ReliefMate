...
class ApproveDonorView extends StatefulWidget {
  const ApproveDonorView({super.key});

  @override
  State<ApproveDonorView> createState() => _ApproveDonorViewState();
}

class _ApproveDonorViewState extends State<ApproveDonorView> {
