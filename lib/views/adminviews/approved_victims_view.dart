...
class ApprovedVictimsView extends StatefulWidget {
  const ApprovedVictimsView({super.key});

  @override
  State<ApprovedVictimsView> createState() => _ApprovedVictimsViewState();
}

class _ApprovedVictimsViewState extends State<ApprovedVictimsView> {
