...
class DisapprovedVictimsView extends StatefulWidget {
  const DisapprovedVictimsView({super.key});

  @override
  State<DisapprovedVictimsView> createState() => _DisapprovedVictimsViewState();
}

class _DisapprovedVictimsViewState extends State<DisapprovedVictimsView> {
