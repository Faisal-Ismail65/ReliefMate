...
class PendingVictimsView extends StatefulWidget {
  const PendingVictimsView({super.key});

  @override
  State<PendingVictimsView> createState() => _PendingVictimsViewState();
}

class _PendingVictimsViewState extends State<PendingVictimsView> {
